<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master"
    AutoEventWireup="true" CodeFile="PublicHealthProfiling.aspx.cs" Inherits="Public_PublicHealthProfiling" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                    ...
                    <table width="874" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <table width="100%" cellpadding="3" cellspacing="0">
                                            <tr>
                                                <td width="5%" valign="top">
                                                    ...
                                                    <asp:Label ID="lblQuestionId" runat="server" Text='<%# Eval("QuestionId") %>' Width="10px"
                        ...
                        <tr>
                            <td valign="middle" style="display:none">
                                &nbsp;
                                    <asp:Label ID="lblMsg" runat="server" meta:resourcekey="lblMsgResource1" Text="Are you sure, you want to clear all the questions?"></asp:Label>
