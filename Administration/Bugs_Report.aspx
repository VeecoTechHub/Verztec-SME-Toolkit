<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="Bugs_Report.aspx.cs" Inherits="Administration_Bugs_Report" %>
...
<table id="Table3" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="background-image: url(../images/bg.jpg);
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvBugs" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Bugs Comments">
