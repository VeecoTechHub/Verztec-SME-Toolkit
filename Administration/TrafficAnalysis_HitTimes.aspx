<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="TrafficAnalysis_HitTimes.aspx.cs" Inherits="Administration_TrafficAnalysis_HitTimes" %>
    ...
    <table id="Table3" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="background-image: url(../images/bg.jpg);
                    ...
                    <tr>
                        ...
                        <td colspan="1" height="3" style="width: 370px">
                            <asp:ImageButton ID="Button_Go" runat="server" ImageUrl="~/images/search.jpg" 
                                onclick="Button_Go_Click" Height="21px"  />
       ...
       <table>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:GridView ID="gvTrafficAnalysisHitTimes" runat="server" ShowFooter="true" Width="100%"
                    AutoGenerateColumns="False" CellPadding="1" BorderColor="Black" AllowSorting="True"
                    CaptionAlign="Top" OnRowDataBound="gvTrafficAnalysisHitTimes_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Generate FinancialModeling" >
                          ...
                          <asp:TemplateField HeaderText="DownLoad Reports" >
                            <HeaderStyle ForeColor="Black"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_Financial_Modeling" runat="server" Text='<%#Eval("FINANCIAL_MODELING") %>'></asp:Label></ItemTemplate>
                            <FooterTemplate>
                                <asp:Label ID="lblTotal_FM" runat="server" />
                            </FooterTemplate>
                            <HeaderStyle HorizontalAlign="center" />
                              <FooterStyle HorizontalAlign="Right" CssClass="gvItems"/>
                            <ItemStyle HorizontalAlign="Right" Width="80" CssClass="gvItems" />
                        ...
                        <asp:TemplateField HeaderText="Faqs Online Help" >
                            <HeaderStyle ForeColor="Black" Width="80"></HeaderStyle>
                            <ItemTemplate>
