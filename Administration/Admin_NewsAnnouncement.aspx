<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true"
    CodeFile="Admin_NewsAnnouncement.aspx.cs" Inherits="Administration_Admin_NewsAnnouncement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <td colspan="3">
                <table id="Table1" width="770px" align="left" border="0" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td style="width: 370px">
                            <asp:TextBox ID="txtNewsTitle" runat="server" MaxLength="20" Width="55px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="formlabel" style="width: 200px">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="height: 38px" valign="bottom" align="right">
               <%-- <asp:ImageButton ID="Button_New" runat="server" ImageUrl="~/images/add.jpg" OnClick="Button_New_Click1"
                    Style="height: 21px"></asp:ImageButton>--%>
        ...
        <tr>
            <td colspan="2">
                <asp:DataGrid ID="DG_NewsDetails"  runat="server" Width="747px" 
                    AutoGenerateColumns="False"   CellPadding="1" BorderColor="Black" 
                    CaptionAlign="Top" onitemcommand="DG_NewsDetails_ItemCommand" 
                    onitemdatabound="DG_NewsDetails_ItemDataBound" 
                    onpageindexchanged="DG_NewsDetails_PageIndexChanged" AllowPaging="true" 
                    onitemcreated="DG_NewsDetails_ItemCreated">
                    <HeaderStyle CssClass="tableHeading"></HeaderStyle>
                    <Columns>
                        <asp:TemplateColumn HeaderText="Select">
                            <HeaderStyle ForeColor="Black" Width="10"></HeaderStyle>
                            <ItemTemplate>
                                <input type="checkbox" name="Cbx_uid" value='<%#DataBinder.Eval(Container.DataItem, "N_ID")%>'>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="Article Description">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_ArticleDescription" runat="server" Text='<%#Eval("NewsDescription") %>'></asp:Label></ItemTemplate>
                            <HeaderStyle HorizontalAlign="left" />
                            <ItemStyle HorizontalAlign="left" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Topic">
                            <HeaderStyle ForeColor="Black" Width="80"></HeaderStyle>
                            <ItemTemplate>
                                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%#Eval("N_ID")%>' />
