...
public partial class Administration_Improvement_Report : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        try
        {
            ...
            DataSet ds_Search = obj_Feedback.Get_Improvement_Comments(obj_Feedback);
            ...
            if (ds_Search.Tables[0].Rows.Count > 0)
            {
                ...
                gvImprovement.DataSource = ds_Search;
                gvImprovement.DataBind();
            }
            else
            {
    ...
    protected void ExportToExcel()
    {
        ...
        gvImprovement.RenderControl(htmlWrite);     //throwing error 
