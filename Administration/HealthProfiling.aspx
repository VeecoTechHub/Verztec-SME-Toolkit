<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true"
    CodeFile="HealthProfiling.aspx.cs" Inherits="Administration_HealthProfiling" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                 ...
                 <%--   <tr>
                        ...
                        <td style="width: 74%">
                            <asp:DropDownList ID="ddlCategory" runat="server">
                              ...
                              <asp:RequiredFieldValidator ID="rfvquecategory" InitialValue="Select" runat="server" ControlToValidate="ddlCategory"
                    ...
                    <tr>
                        ...
                        <td style="width: 370px">
                            <asp:TextBox ID="txt_Description" runat="server" MaxLength="20" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="formlabel" style="width: 200px">
                    ...
                    <tr>
                        ...
                        <td class="" nowrap="nowrap" style="width: 1px">
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style=" height: 2px;" width="370px">
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
               <asp:DataGrid ID="DG_HealthProfile" runat="server" Width="747px" AllowPaging="True" 
                    AutoGenerateColumns="false" CellPadding="1" BorderColor="Black" AllowSorting="True"
                    CaptionAlign="Top" OnPageIndexChanged="DG_HealthProfile_PageIndexChanged" OnSortCommand="DG_HealthProfile_SortCommand"
                    OnItemDataBound="DG_HealthProfile_ItemDataBound">
                     <HeaderStyle CssClass="tableHeading"></HeaderStyle>
                    <Columns>
                        <asp:TemplateColumn HeaderText="Select">
                            <HeaderStyle ForeColor="Black" Width="10"></HeaderStyle>
                            <ItemTemplate>
                              <%--  <input type="checkbox" name="Cbx_qid" value='<%#DataBinder.Eval(Container.DataItem, "QId")%>'>--%>
                              <input type="checkbox" name="Cbx_uid" value='<%#DataBinder.Eval(Container.DataItem, "QId")%>'>
                       ...
                       <%-- <asp:TemplateColumn HeaderText="Description">
                            <HeaderStyle ForeColor="Black" Width="80"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_Desc" runat="server" Text='<%#Eval("Qdescription")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>--%>
                        <asp:TemplateColumn HeaderText="Option A">
                            <HeaderStyle ForeColor="Black" Width="80"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_OptA" runat="server" Text='<%#Eval("OptA")%>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="Option B">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lbl_OptB" runat="server" Text='<%#Eval("OptB") %>'></asp:Label></ItemTemplate>
                            <HeaderStyle HorizontalAlign="left" />
                            <ItemStyle HorizontalAlign="left" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Option C">
                            <HeaderStyle ForeColor="Black" Width="80"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_OptC" runat="server" Text='<%#Eval("OptC")%>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="left" />
                            <ItemStyle HorizontalAlign="left" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Option B">
                            <HeaderStyle ForeColor="Black" Width="100"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_OptD" runat="server" Text='<%#Eval("OptD") %>'></asp:Label></ItemTemplate>
                            <HeaderStyle HorizontalAlign="left" />
                            <ItemStyle HorizontalAlign="left" />
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="Category">
                            <HeaderStyle ForeColor="Black" Width="100"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_OptD" runat="server" Text='<%#Eval("Category") %>'></asp:Label></ItemTemplate>
                            <HeaderStyle HorizontalAlign="left" />
                            <ItemStyle HorizontalAlign="left" />
                        </asp:TemplateColumn>
                    </Columns>
              ...
              <%--  <asp:DataGrid ID="DG_HealthProfile" runat="server" Width="747px" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Description">
                            <HeaderStyle ForeColor="Black" Width="100"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lbl_ArticleDescription" runat="server" Text='<%#Eval("Description") %>'></asp:Label></ItemTemplate>
                            <HeaderStyle HorizontalAlign="left" />
                            <ItemStyle HorizontalAlign="left" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Category">
