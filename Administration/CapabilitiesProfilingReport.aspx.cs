...
public partial class Administration_CapabilitiesProfilingReport : System.Web.UI.Page
{
    //private HealthProfiling obj_Hpetails = new HealthProfiling();
    private FinancialMgtCapabilities obj_FmCapabilities = new FinancialMgtCapabilities();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            obj_FmCapabilities.StartDate = null;
            obj_FmCapabilities.EndDate = null;
    ...
    //    dscat = obj_FmCapabilities.Get_QueCategory_ManageCapabilities();
    ...
    void Bind_Data()
    {
        ...
        //{ obj_FmCapabilities.Category = ddlCategory.SelectedItem.Text; }
        //else
        //{
        //    obj_FmCapabilities.Category = "all";
        //}


        DsReport.Tables.Clear();
        DsReport = obj_FmCapabilities.Get_ReportCapabilitiesProfiling(obj_FmCapabilities);
    ...
    protected void Button_Go_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            // DatePicker_EndDate.DateString = DateTime.Now.Date.ToString();
            obj_FmCapabilities.EndDate = DateTime.Now.Date.ToString();

        }
        else
        {
            obj_FmCapabilities.StartDate = Convert.ToString(DatePicker_StartDate.Date);
            obj_FmCapabilities.EndDate = Convert.ToString(DatePicker_EndDate.Date);
        }
        Bind_Data();
