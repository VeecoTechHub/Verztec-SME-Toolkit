<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.master" AutoEventWireup="true" CodeFile="Admin_LibraryResource.aspx.cs" Inherits="Administration_AdminLibraryResources" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <td colspan="3">
                <table id="Table1" width="770px" align="left" border="0" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td style="width: 370px">
                            <asp:TextBox ID="txtCourseTitle" runat="server" MaxLength="20" Width="400px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="formlabel" style="width: 200px">
                    ...
                    <tr>
                        ...
                        <td colspan="1" height="3" width="370px">
                            <asp:ImageButton ID="Button_Go" runat="server" ImageUrl="~/images/search.jpg" 
                                OnClick="Button_Go_Click" style="height: 21px">
                            </asp:ImageButton>
                        </td>
                    </tr>
                </table>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                <span id="spSelect" runat="server" visible="false">
        ...
        <tr>
            <td colspan="2">
                <asp:DataGrid ID="DG_ResourcesLibrary" runat="server" Width="100%" AllowPaging="True"
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="Select">
                            <HeaderStyle ForeColor="Black" Width="5%"></HeaderStyle>
                            <ItemTemplate>
                                <input type="checkbox" name="Cbx_uid" value='<%#DataBinder.Eval(Container.DataItem, "RL_ID")%>'>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Title">
                            <HeaderStyle ForeColor="Black" Width="25%"></HeaderStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="Category">
                            <HeaderStyle ForeColor="Black" Width="15%"></HeaderStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="Status">
                            <HeaderStyle ForeColor="Black" Width="6%"></HeaderStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblStatus" runat="server"></asp:Label>
                                <asp:HiddenField ID="hdfldStatus" runat="server" Value='<%#Eval("RL_Status")%>' />
                                 <%--<asp:Label ID="Label1" runat="server" Text='<%#  Eval("RL_Status").tostring() != '0' ? Eval("RL_Status").ToString() : Eval("RL_Status").ToString()%>'></asp:Label>--%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
