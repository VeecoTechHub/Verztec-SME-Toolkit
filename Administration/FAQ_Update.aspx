<%@ Page Language="C#" MasterPageFile="~/Masterpages/Admin.master" AutoEventWireup="true"
    CodeFile="FAQ_Update.aspx.cs" Inherits="Administration_FAQ_Update" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <td colspan="4" height="35" valign="top">
                            <table cellspacing="3" style="vertical-align: top;">
                                <tr>
                                    ...
                                    <td style="height: 23px">
                                        <asp:ImageButton ID="btnReset" runat="server" ImageUrl="~/images/reset.jpg" CausesValidation="false"
    ...
    function SuccessRegister()
    {
        ...
        window.location="FAQ_SEARCH.aspx"; 
    }
        </script>
