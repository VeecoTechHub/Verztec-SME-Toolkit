<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master"
    AutoEventWireup="true" CodeFile="Optional.aspx.cs" Inherits="FinancialModeling_Optional"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
            <td height="300" valign="top">
                <table width="874" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <td height="29">
                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="navbg">
                                                    <asp:LinkButton ID="lnkOtherAssetsAndLiabilities0" runat="server" OnClick="SaveData"
                                                ...
                                                <td class="navbg_hover">
                                                    <asp:LinkButton ID="lnkOptional0" runat="server" class="menu_link_select">Optional</asp:LinkButton>
                                                </td>
                                                <td>
                                                    <img src="../images/right_select.png" width="41" height="82" alt="" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="navbg">
                                                    <asp:LinkButton ID="lnkOtherAssetsAndLiabilities1" runat="server" OnClick="SaveData"
                                                        OnClientClick="ConfirmChoice();" class="menu_link" CommandArgument="FinancialModeling/Other_Assets.aspx?Id=1">Other <br />Assets and <br />Liabilities</asp:LinkButton>
                                                </td>
                                                <td>
                                                    <img src="../images/hover_left.png" width="41" height="82" alt="" />
                                                </td>
                                                <td class="navbg_hover">
                                                    <asp:LinkButton ID="lnkOptional1" runat="server" class="menu_link_select">Optional</asp:LinkButton>
                                                </td>
                                                <td>
                                                    <img src="../images/right_select.png" width="41" height="82" alt="" />
                                                </td>
                    ...
                    <tr>
                        <td>
                            <strong>SECTION 6 - EXISTING ASSETS AND DEPRECIATION</strong>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td valign="top">
                            <table width="875" border="0" align="center" cellpadding="3" cellspacing="1">
                                <tr>
                                    ...
                                    <td width="106" align="center" bgcolor="#E9E9E9" id="tdActual_1">
                                        Estimate<br />
                                    ...
                                    <td width="106" align="center" bgcolor="#E9E9E9">
                                        Projection<br />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        The net book value of your Property, Plant &amp; Equipment as at end of the period
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    <td align="center" id="tdActual_2">
                                        $<asp:TextBox ID="txtAssetsEst" runat="server" CssClass="InputBgColor" Style="width: 90px;"
                                    ...
                                    <td align="center">
                                        <%--  $ 30,000&nbsp;--%>
                                        $
                                        <asp:Label ID="lblAssetsP1" runat="server" Text="30000"></asp:Label>&nbsp;
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    <td align="center">
                                        <%--  $ 15,000--%>
                                        $
                                        <asp:Label ID="lblAssetsP2" runat="server" Text="15000"></asp:Label>
                                    </td>
                                    <td align="center">
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Estimate the depreciation charges of the existing assets for the period
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    ...
                                    <td align="center">
                                        $<asp:TextBox ID="txtDepreciationP1" runat="server" CssClass="InputBgColor" Style="width: 90px;"
                                            MaxLength="15"></asp:TextBox>
                                    </td>
                                    <td>
                                        &nbsp;
                                    ...
                                    <td align="center">
                                        $<asp:TextBox ID="txtDepreciationP2" runat="server" CssClass="InputBgColor" Style="width: 90px;"
                                            MaxLength="15"></asp:TextBox>
                                    </td>
                                    <td align="center">
                                        &nbsp;
                                    ...
                                    <td align="center">
                                        $<asp:TextBox ID="txtDepreciationP3" runat="server" CssClass="InputBgColor" Style="width: 90px;"
                                            MaxLength="15"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td>
                            <strong>SECTION 7 - INCOME TAX</strong>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <td valign="top">
                            <table width="875" border="0" align="center" cellpadding="3" cellspacing="1">
                                <tr>
                                    ...
                                    <td width="337">
                                        Income tax expenses last financial year
                                    </td>
                                    <td width="13">
                                        &nbsp;
                                    </td>
                                    <td width="65" align="center">
                                        <%--($ 3,000)--%>
                                        ($
                                        <asp:Label ID="lblIncometax" runat="server" Text="3000"></asp:Label>)
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Income tax as a % of the profit before tax last year was
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Enter your estimated income tax rate for projection years
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    <td align="center">
                                        <asp:TextBox ID="txtIncometax" runat="server" CssClass="InputBgColor" Style="width: 40px;"
                                            MaxLength="15"></asp:TextBox>
                                        %
                                    </td>
                                    <td align="center">
    ...
    <script type="text/javascript">
        ...
        function NavigatePage() {
            window.location = 'default.htm?Id=' + paramval;
        }
